    ...
    public partial class WorldAssetEditor
    {
        ...
        private void SkipGroupInEditor(string groupName, bool skip)
        {
            ...
            if (skip)
            {
                ...
                {
                    stage.ReplaceComponentForInstance(parentGuid: null, g, new SkipEntityOnEditorComponent());
                }
            }
            else
            {
                ...
                foreach (Guid g in entities)
                {
                    stage.RemoveComponentForInstance(parentGuid: null, g, typeof(SkipEntityOnEditorComponent));
                }
            }
        ...
        private void SavePersistentWorldInfo(WorldStageInfo info)
        {
            ...
            Architect.EditorSettings.WorldAssetInfo[_world.Guid] = new(info.SkipGroups, info.HiddenGroups);
        }
