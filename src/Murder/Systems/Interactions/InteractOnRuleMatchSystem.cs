...
[Filter(typeof(RuleWatcherAllComponent))]
[Watch(typeof(RuleWatcherAllComponent))]
public class RuleCleanupSystem : IStartupSystem, IReactiveSystem
{
    public void Start(Context context)
    {
        _ = context.World.AddEntity(new RuleWatcherAllComponent());
    }
