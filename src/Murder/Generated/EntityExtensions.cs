...
namespace Bang.Entities
{
    public enum MurderComponentType
    {
        ...
        Friction = 43,
        GlobalShader = 44,
        GuidToIdTargetCollection = 45,
        GuidToIdTarget = 46,
        HAAStarPathfind = 47,
        HasVision = 48,
        HighlightOnChildren = 49,
        HighlightSprite = 50,
        IdTargetCollection = 51,
        IdTarget = 52,
        IgnoreTriggersUntil = 53,
        InCamera = 54,
        Indestructible = 55,
        InstanceToEntityLookup = 56,
        InteractOnCollision = 57,
        InteractOnRuleMatchCollection = 58,
        InteractOnRuleMatch = 59,
        InteractOnStart = 60,
        Interactor = 61,
        Line = 62,
        Map = 63,
        ...
        Parallax = 69,
        ParticleSystem = 70,
        ParticleSystemWorldTracker = 71,
        Pathfind = 72,
        PauseAnimation = 73,
        PickEntityToAddOnStart = 74,
        PolygonSprite = 75,
        PrefabRef = 76,
        PushAway = 77,
        Quadtree = 78,
        QuestTracker = 79,
        QuestTrackerRuntime = 80,
        RandomizeSprite = 81,
        RectPosition = 82,
        Reflection = 83,
        RemoveColliderWhenStopped = 84,
        RemoveEntityOnRuleMatchAtLoad = 85,
        RequiresVision = 86,
        Room = 87,
        Rotate = 88,
        Route = 89,
        ...
        UiDisplay = 103,
        Velocity = 104,
        VerticalPosition = 105,
        WaitForVacancy = 106,
        WindowRefreshTracker = 107,
        StateMachine = 108,
        Interactive = 109,
        Transform = 110,
        TransformBase = 110
    ...
    public enum MurderMessageType
    {
        ...
        IsInsideOf = 118,
        NextDialog = 119,
        OnActorEnteredOrExited = 120,
        OnInteractExit = 121,
        OnTriggerEntered = 122,
        PathNotPossible = 123,
        PickChoice = 124,
        TouchedGround = 125
    }
    ...
    public static class MurderEntityExtensions
    {
        ...
        {
            e.AddOrReplaceComponent(new FlashSpriteComponent(destroyTimer), 40);
        }

        public static void SetFlashSprite(this Entity e)
        {
            e.AddOrReplaceComponent(new FlashSpriteComponent(), 40);
        }
        ...
        {
            e.AddOrReplaceComponent(new FreeMovementComponent(), 41);
        }
        ...
        {
            e.AddOrReplaceComponent(new FreezeWorldComponent(), 42);
        }

        public static void SetFreezeWorld(this Entity e, System.Int32 count)
        {
            e.AddOrReplaceComponent(new FreezeWorldComponent(count), 42);
        }
        ...
        {
            e.AddOrReplaceComponent(new FrictionComponent(amount), 43);
        }

        public static void SetFriction(this Entity e)
        {
            e.AddOrReplaceComponent(new FrictionComponent(), 43);
        }
        ...
        {
            e.AddOrReplaceComponent(new GlobalShaderComponent(), 44);
        }
        ...
        {
            e.AddOrReplaceComponent(new GuidToIdTargetCollectionComponent(), 45);
        }
        ...
        {
            e.AddOrReplaceComponent(new GuidToIdTargetComponent(target), 46);
        }

        public static void SetGuidToIdTarget(this Entity e)
        {
            e.AddOrReplaceComponent(new GuidToIdTargetComponent(), 46);
        }
        ...
        {
            e.AddOrReplaceComponent(new HAAStarPathfindComponent(width, height), 47);
        }

        public static void SetHAAStarPathfind(this Entity e)
        {
            e.AddOrReplaceComponent(new HAAStarPathfindComponent(), 47);
        }
        ...
        {
            e.AddOrReplaceComponent(new HasVisionComponent(), 48);
        }
        ...
        {
            e.AddOrReplaceComponent(new HighlightOnChildrenComponent(), 49);
        }
        ...
        {
            e.AddOrReplaceComponent(new HighlightSpriteComponent(color), 50);
        }

        public static void SetHighlightSprite(this Entity e)
        {
            e.AddOrReplaceComponent(new HighlightSpriteComponent(), 50);
        }
        ...
        {
            e.AddOrReplaceComponent(new IdTargetCollectionComponent(targets), 51);
        }

        public static void SetIdTargetCollection(this Entity e)
        {
            e.AddOrReplaceComponent(new IdTargetCollectionComponent(), 51);
        }
        ...
        {
            e.AddOrReplaceComponent(new IdTargetComponent(target), 52);
        }

        public static void SetIdTarget(this Entity e)
        {
            e.AddOrReplaceComponent(new IdTargetComponent(), 52);
        }
        ...
        {
            e.AddOrReplaceComponent(new IgnoreTriggersUntilComponent(until), 53);
        }

        public static void SetIgnoreTriggersUntil(this Entity e)
        {
            e.AddOrReplaceComponent(new IgnoreTriggersUntilComponent(), 53);
        }
        ...
        {
            e.AddOrReplaceComponent(new InCameraComponent(renderPosition), 54);
        }

        public static void SetInCamera(this Entity e)
        {
            e.AddOrReplaceComponent(new InCameraComponent(), 54);
        }
        ...
        {
            e.AddOrReplaceComponent(new IndestructibleComponent(), 55);
        }
        ...
        {
            e.AddOrReplaceComponent(new InstanceToEntityLookupComponent(), 56);
        }
        ...
        {
            e.AddOrReplaceComponent(new InstanceToEntityLookupComponent(instancesToEntities), 56);
        }
        ...
        {
            e.AddOrReplaceComponent(new InteractOnCollisionComponent(), 57);
        }

        public static void SetInteractOnCollision(this Entity e, System.Boolean playerOnly)
        {
            e.AddOrReplaceComponent(new InteractOnCollisionComponent(playerOnly), 57);
        }

        public static void SetInteractOnCollision(this Entity e, System.Boolean playerOnly, System.Boolean sendMessageOnExit)
        {
            e.AddOrReplaceComponent(new InteractOnCollisionComponent(playerOnly, sendMessageOnExit), 57);
        }
        ...
        {
            e.AddOrReplaceComponent(new InteractOnRuleMatchCollectionComponent(), 58);
        }
        ...
        {
            e.AddOrReplaceComponent(new InteractOnRuleMatchCollectionComponent(requirements), 58);
        }
        ...
        {
            e.AddOrReplaceComponent(new InteractOnRuleMatchComponent(), 59);
        }
        ...
        {
            e.AddOrReplaceComponent(new InteractOnRuleMatchComponent(interactOn, after, requirements), 59);
        }
        ...
        {
            e.AddOrReplaceComponent(new InteractOnRuleMatchComponent(after, triggered, requirements), 59);
        }

        public static void SetInteractOnRuleMatch(this Entity e, Murder.Core.Dialogs.CriterionNode[] criteria)
        {
            e.AddOrReplaceComponent(new InteractOnRuleMatchComponent(criteria), 59);
        }
        ...
        {
            e.AddOrReplaceComponent(new InteractOnStartComponent(), 60);
        }
        ...
        {
            e.AddOrReplaceComponent(new InteractorComponent(), 61);
        }
        ...
        {
            e.AddOrReplaceComponent(new LineComponent(line, start), 62);
        }

        public static void SetLine(this Entity e)
        {
            e.AddOrReplaceComponent(new LineComponent(), 62);
        }
        ...
        {
            e.AddOrReplaceComponent(new MapComponent(width, height), 63);
        }

        public static void SetMap(this Entity e)
        {
            e.AddOrReplaceComponent(new MapComponent(), 63);
        }
        ...
        {
            e.AddOrReplaceComponent(new MoveToComponent(target), 64);
        }
        ...
        {
            e.AddOrReplaceComponent(new MoveToComponent(target, minDistance, slowDownDistance), 64);
        }

        public static void SetMoveTo(this Entity e)
        {
            e.AddOrReplaceComponent(new MoveToComponent(), 64);
        }
        ...
        {
            e.AddOrReplaceComponent(new MoveToPerfectComponent(target, duration, ease), 65);
        }

        public static void SetMoveToPerfect(this Entity e)
        {
            e.AddOrReplaceComponent(new MoveToPerfectComponent(), 65);
        }
        ...
        {
            e.AddOrReplaceComponent(new MusicComponent(), 66);
        }

        public static void SetMusic(this Entity e, Murder.Core.Sounds.SoundEventId id)
        {
            e.AddOrReplaceComponent(new MusicComponent(id), 66);
        }
        ...
        {
            e.AddOrReplaceComponent(new NineSliceComponent(), 67);
        }
        ...
        {
            e.AddOrReplaceComponent(new OnEnterOnExitComponent(), 68);
        }
        ...
        {
            e.AddOrReplaceComponent(new OnEnterOnExitComponent(onEnter, onExit), 68);
        }
        ...
        {
            e.AddOrReplaceComponent(new ParallaxComponent(), 69);
        }
        ...
        {
            e.AddOrReplaceComponent(new ParticleSystemComponent(asset, destroy), 70);
        }

        public static void SetParticleSystem(this Entity e)
        {
            e.AddOrReplaceComponent(new ParticleSystemComponent(), 70);
        }
        ...
        {
            e.AddOrReplaceComponent(new ParticleSystemWorldTrackerComponent(), 71);
        }
        ...
        {
            e.AddOrReplaceComponent(new PathfindComponent(target, algorithm), 72);
        }

        public static void SetPathfind(this Entity e)
        {
            e.AddOrReplaceComponent(new PathfindComponent(), 72);
        }
        ...
        {
            e.AddOrReplaceComponent(new PauseAnimationComponent(), 73);
        }
        ...
        {
            e.AddOrReplaceComponent(new PickEntityToAddOnStartComponent(), 74);
        }
        ...
        {
            e.AddOrReplaceComponent(new PolygonSpriteComponent(), 75);
        }
        ...
        {
            e.AddOrReplaceComponent(new PrefabRefComponent(assetGui), 76);
        }

        public static void SetPrefabRef(this Entity e)
        {
            e.AddOrReplaceComponent(new PrefabRefComponent(), 76);
        }
        ...
        {
            e.AddOrReplaceComponent(new PushAwayComponent(size, strength), 77);
        }

        public static void SetPushAway(this Entity e)
        {
            e.AddOrReplaceComponent(new PushAwayComponent(), 77);
        }
        ...
        {
            e.AddOrReplaceComponent(new QuadtreeComponent(size), 78);
        }

        public static void SetQuadtree(this Entity e)
        {
            e.AddOrReplaceComponent(new QuadtreeComponent(), 78);
        }
        ...
        {
            e.AddOrReplaceComponent(new QuestTrackerComponent(), 79);
        }
        ...
        {
            e.AddOrReplaceComponent(new QuestTrackerRuntimeComponent(), 80);
        }
        ...
        {
            e.AddOrReplaceComponent(new QuestTrackerRuntimeComponent(questStages), 80);
        }
        ...
        {
            e.AddOrReplaceComponent(new RandomizeSpriteComponent(), 81);
        }
        ...
        {
            e.AddOrReplaceComponent(new RectPositionComponent(top, left, bottom, right, size, origin, parent), 82);
        }

        public static void SetRectPosition(this Entity e)
        {
            e.AddOrReplaceComponent(new RectPositionComponent(), 82);
        }
        ...
        {
            e.AddOrReplaceComponent(new ReflectionComponent(), 83);
        }
        ...
        {
            e.AddOrReplaceComponent(new RemoveColliderWhenStoppedComponent(), 84);
        }
        ...
        {
            e.AddOrReplaceComponent(new RemoveEntityOnRuleMatchAtLoadComponent(), 85);
        }
        ...
        {
            e.AddOrReplaceComponent(new RequiresVisionComponent(), 86);
        }
        ...
        {
            e.AddOrReplaceComponent(new RoomComponent(), 87);
        }

        public static void SetRoom(this Entity e, System.Guid floor)
        {
            e.AddOrReplaceComponent(new RoomComponent(floor), 87);
        }
        ...
        {
            e.AddOrReplaceComponent(new RotateComponent(), 88);
        }

        public static void SetRotate(this Entity e, System.Single rotation)
        {
            e.AddOrReplaceComponent(new RotateComponent(rotation), 88);
        }
        ...
        {
            e.AddOrReplaceComponent(new RouteComponent(route, initial, target), 89);
        }

        public static void SetRoute(this Entity e)
        {
            e.AddOrReplaceComponent(new RouteComponent(), 89);
        }
        ...
        {
            e.AddOrReplaceComponent(new RuleWatcherComponent(), 90);
        }
        ...
        {
            e.AddOrReplaceComponent(new SituationComponent(), 91);
        }

        public static void SetSituation(this Entity e, System.Guid character, System.Int32 situation)
        {
            e.AddOrReplaceComponent(new SituationComponent(character, situation), 91);
        }
        ...
        {
            e.AddOrReplaceComponent(new SoundComponent(), 92);
        }

        public static void SetSound(this Entity e, Murder.Core.Sounds.SoundEventId sound, System.Boolean destroyEntity)
        {
            e.AddOrReplaceComponent(new SoundComponent(sound, destroyEntity), 92);
        }
        ...
        {
            e.AddOrReplaceComponent(new SoundParameterComponent(), 93);
        }
        ...
        {
            e.AddOrReplaceComponent(new SoundWatcherComponent(), 94);
        }
        ...
        {
            e.AddOrReplaceComponent(new SpeakerComponent(speaker), 95);
        }

        public static void SetSpeaker(this Entity e)
        {
            e.AddOrReplaceComponent(new SpeakerComponent(), 95);
        }
        ...
        {
            e.AddOrReplaceComponent(new SpriteComponent(), 96);
        }

        public static void SetSprite(this Entity e, Murder.Core.Portrait portrait)
        {
            e.AddOrReplaceComponent(new SpriteComponent(portrait), 96);
        }
        ...
        {
            e.AddOrReplaceComponent(new SpriteComponent(guid, offset, id, ySortOffset, backAnim, flip, highlightStyle, startTime, targetSpriteBatch), 96);
        }
        ...
        {
            e.AddOrReplaceComponent(new SpriteComponent(guid, offset, id, ySortOffset, rotate, flip, highlightStyle, startTime, targetSpriteBatch), 96);
        }
        ...
        {
            e.AddOrReplaceComponent(new StaticComponent(), 97);
        }
        ...
        {
            e.AddOrReplaceComponent(new StrafingComponent(), 98);
        }
        ...
        {
            e.AddOrReplaceComponent(new TextBoxComponent(text, visibleCharacters, fontSize, sorting, color, offset), 99);
        }

        public static void SetTextBox(this Entity e)
        {
            e.AddOrReplaceComponent(new TextBoxComponent(), 99);
        }
        ...
        {
            e.AddOrReplaceComponent(new ThreeSliceComponent(), 100);
        }
        ...
        {
            e.AddOrReplaceComponent(new UiDisplayComponent(), 103);
        }
        ...
        {
            e.AddOrReplaceComponent(new VelocityComponent(velocity), 104);
        }

        public static void SetVelocity(this Entity e, System.Single x, System.Single y)
        {
            e.AddOrReplaceComponent(new VelocityComponent(x, y), 104);
        }

        public static void SetVelocity(this Entity e)
        {
            e.AddOrReplaceComponent(new VelocityComponent(), 104);
        }
        ...
        {
            e.AddOrReplaceComponent(new VerticalPositionComponent(), 105);
        }

        public static void SetVerticalPosition(this Entity e, System.Single z, System.Single zVelocity, System.Boolean hasGravity)
        {
            e.AddOrReplaceComponent(new VerticalPositionComponent(z, zVelocity, hasGravity), 105);
        }
        ...
        {
            e.AddOrReplaceComponent(new WaitForVacancyComponent(alertParent), 106);
        }

        public static void SetWaitForVacancy(this Entity e)
        {
            e.AddOrReplaceComponent(new WaitForVacancyComponent(), 106);
        }
        ...
        {
            e.AddOrReplaceComponent(new WindowRefreshTrackerComponent(), 107);
        }
    ...
    public class MurderLookupImplementation : ComponentsLookup
    {
        ...
        private static readonly ImmutableDictionary<Type, int> _componentsIndex = new Dictionary<Type, int>()
        {
            ...
            { typeof(FlashSpriteComponent), 40 },
            { typeof(FreeMovementComponent), 41 },
            { typeof(FreezeWorldComponent), 42 },
            { typeof(FrictionComponent), 43 },
            { typeof(GlobalShaderComponent), 44 },
            { typeof(GuidToIdTargetCollectionComponent), 45 },
            { typeof(GuidToIdTargetComponent), 46 },
            { typeof(HAAStarPathfindComponent), 47 },
            { typeof(HasVisionComponent), 48 },
            { typeof(HighlightOnChildrenComponent), 49 },
            { typeof(HighlightSpriteComponent), 50 },
            { typeof(IdTargetCollectionComponent), 51 },
            { typeof(IdTargetComponent), 52 },
            { typeof(IgnoreTriggersUntilComponent), 53 },
            { typeof(InCameraComponent), 54 },
            { typeof(IndestructibleComponent), 55 },
            { typeof(InstanceToEntityLookupComponent), 56 },
            { typeof(InteractOnCollisionComponent), 57 },
            { typeof(InteractOnRuleMatchCollectionComponent), 58 },
            { typeof(InteractOnRuleMatchComponent), 59 },
            { typeof(InteractOnStartComponent), 60 },
            { typeof(InteractorComponent), 61 },
            { typeof(LineComponent), 62 },
            { typeof(MapComponent), 63 },
            { typeof(MoveToComponent), 64 },
            { typeof(MoveToPerfectComponent), 65 },
            { typeof(MusicComponent), 66 },
            { typeof(NineSliceComponent), 67 },
            { typeof(OnEnterOnExitComponent), 68 },
            { typeof(ParallaxComponent), 69 },
            { typeof(ParticleSystemComponent), 70 },
            { typeof(ParticleSystemWorldTrackerComponent), 71 },
            { typeof(PathfindComponent), 72 },
            { typeof(PauseAnimationComponent), 73 },
            { typeof(PickEntityToAddOnStartComponent), 74 },
            { typeof(PolygonSpriteComponent), 75 },
            { typeof(PrefabRefComponent), 76 },
            { typeof(PushAwayComponent), 77 },
            { typeof(QuadtreeComponent), 78 },
            { typeof(QuestTrackerComponent), 79 },
            { typeof(QuestTrackerRuntimeComponent), 80 },
            { typeof(RandomizeSpriteComponent), 81 },
            { typeof(RectPositionComponent), 82 },
            { typeof(ReflectionComponent), 83 },
            { typeof(RemoveColliderWhenStoppedComponent), 84 },
            { typeof(RemoveEntityOnRuleMatchAtLoadComponent), 85 },
            { typeof(RequiresVisionComponent), 86 },
            { typeof(RoomComponent), 87 },
            { typeof(RotateComponent), 88 },
            { typeof(RouteComponent), 89 },
            { typeof(RuleWatcherComponent), 90 },
            { typeof(SituationComponent), 91 },
            { typeof(SoundComponent), 92 },
            { typeof(SoundParameterComponent), 93 },
            { typeof(SoundWatcherComponent), 94 },
            { typeof(SpeakerComponent), 95 },
            { typeof(SpriteComponent), 96 },
            { typeof(StaticComponent), 97 },
            { typeof(StrafingComponent), 98 },
            { typeof(TextBoxComponent), 99 },
            { typeof(ThreeSliceComponent), 100 },
            { typeof(TileGridComponent), 101 },
            { typeof(TilesetComponent), 102 },
            { typeof(UiDisplayComponent), 103 },
            { typeof(VelocityComponent), 104 },
            { typeof(VerticalPositionComponent), 105 },
            { typeof(WaitForVacancyComponent), 106 },
            { typeof(WindowRefreshTrackerComponent), 107 },
            { typeof(IStateMachineComponent), 108 },
            { typeof(IInteractiveComponent), 109 },
            { typeof(IMurderTransformComponent), 110 },
            { typeof(ITransformComponent), 110 },
            { typeof(StateMachineComponent<Coroutine>), 108 },
            { typeof(StateMachineComponent<DialogStateMachine>), 108 },
            { typeof(InteractiveComponent<AddChildOnInteraction>), 109 },
            { typeof(InteractiveComponent<AddComponentOnInteraction>), 109 },
            { typeof(InteractiveComponent<AddEntityOnInteraction>), 109 },
            { typeof(InteractiveComponent<AdvancedBlackboardInteraction>), 109 },
            { typeof(InteractiveComponent<BlackboardActionInteraction>), 109 },
            { typeof(InteractiveComponent<DebugInteraction>), 109 },
            { typeof(InteractiveComponent<EnableChildrenInteraction>), 109 },
            { typeof(InteractiveComponent<InteractChildOnInteraction>), 109 },
            { typeof(InteractiveComponent<InteractionCollection>), 109 },
            { typeof(InteractiveComponent<PlayMusicInteraction>), 109 },
            { typeof(InteractiveComponent<PlaySoundInteraction>), 109 },
            { typeof(InteractiveComponent<RemoveEntityOnInteraction>), 109 },
            { typeof(InteractiveComponent<SendToOtherInteraction>), 109 },
            { typeof(InteractiveComponent<SetPositionInteraction>), 109 },
            { typeof(InteractiveComponent<SetSoundOnInteraction>), 109 },
            { typeof(InteractiveComponent<StopMusicInteraction>), 109 },
            { typeof(InteractiveComponent<TalkToInteraction>), 109 },
            { typeof(PositionComponent), 110 }
        ...
        {
            { typeof(AnimationCompleteMessage), 111 },
            { typeof(AnimationEventMessage), 112 },
            { typeof(CollidedWithMessage), 113 },
            { typeof(FatalDamageMessage), 114 },
            { typeof(HighlightMessage), 115 },
            { typeof(InteractMessage), 116 },
            { typeof(InteractorMessage), 117 },
            { typeof(IsInsideOfMessage), 118 },
            { typeof(NextDialogMessage), 119 },
            { typeof(OnActorEnteredOrExitedMessage), 120 },
            { typeof(OnInteractExitMessage), 121 },
            { typeof(OnTriggerEnteredMessage), 122 },
            { typeof(PathNotPossibleMessage), 123 },
            { typeof(PickChoiceMessage), 124 },
            { typeof(TouchedGroundMessage), 125 }
        }.ToImmutableDictionary();
