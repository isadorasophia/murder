...
namespace Bang.Entities
{
    public enum MurderComponentType
    {
        ...
        Friction = 35,
        GlobalShader = 36,
        GuidToIdTargetCollection = 37,
        GuidToIdTarget = 38,
        HAAStarPathfind = 39,
        HasVision = 40,
        HighlightOnChildren = 41,
        HighlightSprite = 42,
        IdTargetCollection = 43,
        IdTarget = 44,
        IgnoreTriggersUntil = 45,
        Indestructible = 46,
        InstanceToEntityLookup = 47,
        InteractOnCollision = 48,
        InteractOnRuleMatchCollection = 49,
        InteractOnRuleMatch = 50,
        InteractOnStart = 51,
        Interactor = 52,
        Line = 53,
        Map = 54,
        ...
        Quadtree = 68,
        QuestTracker = 69,
        QuestTrackerRuntime = 70,
        RandomizeSprite = 71,
        RectPosition = 72,
        RemoveColliderWhenStopped = 73,
        RemoveEntityOnRuleMatchAtLoad = 74,
        RequiresVision = 75,
        Room = 76,
        Rotate = 77,
        Route = 78,
    ...
    public enum MurderMessageType
    {
        ...
        IsInsideOf = 105,
        NextDialog = 106,
        OnActorEnteredOrExited = 107,
        OnInteractExit = 108,
        OnTriggerEntered = 109,
        PathNotPossible = 110,
        PickChoice = 111,
        TouchedGround = 112
    }
    ...
    public static class MurderEntityExtensions
    {
        ...
        {
            e.AddOrReplaceComponent(new DrawRectangleComponent(), 27);
        }
        ...
        {
            e.AddOrReplaceComponent(new EntityTrackerComponent(target), 28);
        }

        public static void SetEntityTracker(this Entity e)
        {
            e.AddOrReplaceComponent(new EntityTrackerComponent(), 28);
        }
        ...
        {
            e.AddOrReplaceComponent(new FacingComponent(direction), 29);
        }

        public static void SetFacing(this Entity e)
        {
            e.AddOrReplaceComponent(new FacingComponent(), 29);
        }
        ...
        {
            e.AddOrReplaceComponent(new FadeScreenComponent(fade, startedTime, duration, color, destroyAfterFinished, customTexture), 30);
        }

        public static void SetFadeScreen(this Entity e)
        {
            e.AddOrReplaceComponent(new FadeScreenComponent(), 30);
        }
        ...
        {
            e.AddOrReplaceComponent(new FadeTransitionComponent(duration, startAlpha, targetAlpha), 31);
        }
        ...
        {
            e.AddOrReplaceComponent(new FadeTransitionComponent(duration, startAlpha, targetAlpha, destroyOnEnd), 31);
        }

        public static void SetFadeTransition(this Entity e)
        {
            e.AddOrReplaceComponent(new FadeTransitionComponent(), 31);
        }
        ...
        {
            e.AddOrReplaceComponent(new FadeWhenInAreaComponent(), 32);
        }
        ...
        {
            e.AddOrReplaceComponent(new FlashSpriteComponent(destroyTimer), 33);
        }

        public static void SetFlashSprite(this Entity e)
        {
            e.AddOrReplaceComponent(new FlashSpriteComponent(), 33);
        }
        ...
        {
            e.AddOrReplaceComponent(new FrictionComponent(amount), 35);
        }

        public static void SetFriction(this Entity e)
        {
            e.AddOrReplaceComponent(new FrictionComponent(), 35);
        }
        ...
        {
            e.AddOrReplaceComponent(new GlobalShaderComponent(), 36);
        }
        ...
        {
            e.AddOrReplaceComponent(new GuidToIdTargetCollectionComponent(), 37);
        }
        ...
        {
            e.AddOrReplaceComponent(new GuidToIdTargetComponent(target), 38);
        }

        public static void SetGuidToIdTarget(this Entity e)
        {
            e.AddOrReplaceComponent(new GuidToIdTargetComponent(), 38);
        }
        ...
        {
            e.AddOrReplaceComponent(new HAAStarPathfindComponent(width, height), 39);
        }

        public static void SetHAAStarPathfind(this Entity e)
        {
            e.AddOrReplaceComponent(new HAAStarPathfindComponent(), 39);
        }
        ...
        {
            e.AddOrReplaceComponent(new HasVisionComponent(), 40);
        }
        ...
        {
            e.AddOrReplaceComponent(new HighlightOnChildrenComponent(), 41);
        }
        ...
        {
            e.AddOrReplaceComponent(new HighlightSpriteComponent(color), 42);
        }

        public static void SetHighlightSprite(this Entity e)
        {
            e.AddOrReplaceComponent(new HighlightSpriteComponent(), 42);
        }
        ...
        {
            e.AddOrReplaceComponent(new IdTargetCollectionComponent(targets), 43);
        }

        public static void SetIdTargetCollection(this Entity e)
        {
            e.AddOrReplaceComponent(new IdTargetCollectionComponent(), 43);
        }
        ...
        {
            e.AddOrReplaceComponent(new IdTargetComponent(target), 44);
        }

        public static void SetIdTarget(this Entity e)
        {
            e.AddOrReplaceComponent(new IdTargetComponent(), 44);
        }
        ...
        {
            e.AddOrReplaceComponent(new IgnoreTriggersUntilComponent(until), 45);
        }

        public static void SetIgnoreTriggersUntil(this Entity e)
        {
            e.AddOrReplaceComponent(new IgnoreTriggersUntilComponent(), 45);
        }
        ...
        {
            e.AddOrReplaceComponent(new IndestructibleComponent(), 46);
        }
        ...
        {
            e.AddOrReplaceComponent(new InstanceToEntityLookupComponent(), 47);
        }
        ...
        {
            e.AddOrReplaceComponent(new InstanceToEntityLookupComponent(instancesToEntities), 47);
        }
        ...
        {
            e.AddOrReplaceComponent(new InteractOnCollisionComponent(), 48);
        }
        ...
        {
            e.AddOrReplaceComponent(new InteractOnRuleMatchCollectionComponent(), 49);
        }
        ...
        {
            e.AddOrReplaceComponent(new InteractOnRuleMatchCollectionComponent(requirements), 49);
        }
        ...
        {
            e.AddOrReplaceComponent(new InteractOnRuleMatchComponent(), 50);
        }
        ...
        {
            e.AddOrReplaceComponent(new InteractOnRuleMatchComponent(after, triggered, requirements), 50);
        }

        public static void SetInteractOnRuleMatch(this Entity e, Murder.Core.Dialogs.CriterionNode[] criteria)
        {
            e.AddOrReplaceComponent(new InteractOnRuleMatchComponent(criteria), 50);
        }
        ...
        {
            e.AddOrReplaceComponent(new InteractOnStartComponent(), 51);
        }
        ...
        {
            e.AddOrReplaceComponent(new InteractorComponent(), 52);
        }
        ...
        {
            e.AddOrReplaceComponent(new NineSliceComponent(), 58);
        }
        ...
        {
            e.AddOrReplaceComponent(new ParallaxComponent(), 59);
        }
        ...
        {
            e.AddOrReplaceComponent(new ParticleSystemComponent(asset, destroy), 60);
        }

        public static void SetParticleSystem(this Entity e)
        {
            e.AddOrReplaceComponent(new ParticleSystemComponent(), 60);
        }
        ...
        {
            e.AddOrReplaceComponent(new ParticleSystemWorldTrackerComponent(), 61);
        }
        ...
        {
            e.AddOrReplaceComponent(new PathfindComponent(target, algorithm), 62);
        }

        public static void SetPathfind(this Entity e)
        {
            e.AddOrReplaceComponent(new PathfindComponent(), 62);
        }
        ...
        {
            e.AddOrReplaceComponent(new PauseAnimationComponent(), 63);
        }
        ...
        {
            e.AddOrReplaceComponent(new PolygonSpriteComponent(), 65);
        }
        ...
        {
            e.AddOrReplaceComponent(new PrefabRefComponent(assetGui), 66);
        }

        public static void SetPrefabRef(this Entity e)
        {
            e.AddOrReplaceComponent(new PrefabRefComponent(), 66);
        }
        ...
        {
            e.AddOrReplaceComponent(new PushAwayComponent(size, strength), 67);
        }

        public static void SetPushAway(this Entity e)
        {
            e.AddOrReplaceComponent(new PushAwayComponent(), 67);
        }
        ...
        {
            e.AddOrReplaceComponent(new QuadtreeComponent(size), 68);
        }

        public static void SetQuadtree(this Entity e)
        {
            e.AddOrReplaceComponent(new QuadtreeComponent(), 68);
        }
        ...
        {
            e.AddOrReplaceComponent(new QuestTrackerComponent(), 69);
        }
        ...
        {
            e.AddOrReplaceComponent(new QuestTrackerRuntimeComponent(), 70);
        }
        ...
        {
            e.AddOrReplaceComponent(new QuestTrackerRuntimeComponent(questStages), 70);
        }
        ...
        {
            e.AddOrReplaceComponent(new RandomizeSpriteComponent(), 71);
        }
        ...
        {
            e.AddOrReplaceComponent(new RectPositionComponent(top, left, bottom, right, size, origin, parent), 72);
        }

        public static void SetRectPosition(this Entity e)
        {
            e.AddOrReplaceComponent(new RectPositionComponent(), 72);
        }
        ...
        {
            e.AddOrReplaceComponent(new RemoveColliderWhenStoppedComponent(), 73);
        }
        ...
        {
            e.AddOrReplaceComponent(new RemoveEntityOnRuleMatchAtLoadComponent(), 74);
        }
        ...
        {
            e.AddOrReplaceComponent(new RequiresVisionComponent(), 75);
        }
        ...
        {
            e.AddOrReplaceComponent(new RoomComponent(), 76);
        }

        public static void SetRoom(this Entity e, System.Guid floor)
        {
            e.AddOrReplaceComponent(new RoomComponent(floor), 76);
        }
        ...
        {
            e.AddOrReplaceComponent(new RotateComponent(), 77);
        }

        public static void SetRotate(this Entity e, System.Single rotation)
        {
            e.AddOrReplaceComponent(new RotateComponent(rotation), 77);
        }
        ...
        {
            e.AddOrReplaceComponent(new RouteComponent(route, initial, target), 78);
        }

        public static void SetRoute(this Entity e)
        {
            e.AddOrReplaceComponent(new RouteComponent(), 78);
        }
        ...
        {
            e.AddOrReplaceComponent(new RuleWatcherComponent(), 79);
        }
        ...
        {
            e.AddOrReplaceComponent(new SituationComponent(), 80);
        }

        public static void SetSituation(this Entity e, System.Guid character, System.Int32 situation)
        {
            e.AddOrReplaceComponent(new SituationComponent(character, situation), 80);
        }
        ...
        {
            e.AddOrReplaceComponent(new SoundComponent(), 81);
        }

        public static void SetSound(this Entity e, Murder.Core.Sounds.SoundEventId sound, System.Boolean destroyEntity)
        {
            e.AddOrReplaceComponent(new SoundComponent(sound, destroyEntity), 81);
        }
        ...
        {
            e.AddOrReplaceComponent(new SoundParameterComponent(), 82);
        }

        public static void SetSoundParameter(this Entity e, Murder.Core.Sounds.ParameterId parameter)
        {
            e.AddOrReplaceComponent(new SoundParameterComponent(parameter), 82);
        }
        ...
        {
            e.AddOrReplaceComponent(new SpeakerComponent(speaker), 83);
        }

        public static void SetSpeaker(this Entity e)
        {
            e.AddOrReplaceComponent(new SpeakerComponent(), 83);
        }
        ...
        {
            e.AddOrReplaceComponent(new SpriteComponent(), 84);
        }

        public static void SetSprite(this Entity e, Murder.Core.Portrait portrait)
        {
            e.AddOrReplaceComponent(new SpriteComponent(portrait), 84);
        }
        ...
        {
            e.AddOrReplaceComponent(new SpriteComponent(guid, offset, id, ySortOffset, backAnim, flip, canBeHighlighted, startTime, targetSpriteBatch), 84);
        }
        ...
        {
            e.AddOrReplaceComponent(new SpriteComponent(guid, offset, id, ySortOffset, rotate, flip, canBeHighlighted, startTime, targetSpriteBatch), 84);
        }
        ...
        {
            e.AddOrReplaceComponent(new StrafingComponent(), 85);
        }
        ...
        {
            e.AddOrReplaceComponent(new TextBoxComponent(text, visibleCaracters, fontSize, sorting, color, offset), 86);
        }

        public static void SetTextBox(this Entity e)
        {
            e.AddOrReplaceComponent(new TextBoxComponent(), 86);
        }
        ...
        {
            e.AddOrReplaceComponent(new TextureComponent(texture, offset), 87);
        }

        public static void SetTexture(this Entity e)
        {
            e.AddOrReplaceComponent(new TextureComponent(), 87);
        }
        ...
        {
            e.AddOrReplaceComponent(new ThreeSliceComponent(), 88);
        }
        ...
        {
            e.AddOrReplaceComponent(new UiDisplayComponent(), 91);
        }
        ...
        {
            e.AddOrReplaceComponent(new VelocityComponent(velocity), 92);
        }

        public static void SetVelocity(this Entity e, System.Single x, System.Single y)
        {
            e.AddOrReplaceComponent(new VelocityComponent(x, y), 92);
        }

        public static void SetVelocity(this Entity e)
        {
            e.AddOrReplaceComponent(new VelocityComponent(), 92);
        }
        ...
        {
            e.AddOrReplaceComponent(new VerticalPositionComponent(), 93);
        }

        public static void SetVerticalPosition(this Entity e, System.Single z, System.Single zVelocity, System.Boolean hasGravity)
        {
            e.AddOrReplaceComponent(new VerticalPositionComponent(z, zVelocity, hasGravity), 93);
        }
        ...
        {
            e.AddOrReplaceComponent(new WaitForVacancyComponent(alertParent), 94);
        }

        public static void SetWaitForVacancy(this Entity e)
        {
            e.AddOrReplaceComponent(new WaitForVacancyComponent(), 94);
        }
        ...
        {
            e.AddOrReplaceComponent(new WindowRefreshTrackerComponent(), 95);
        }
    ...
    public class MurderLookupImplementation : ComponentsLookup
    {
        ...
        private static readonly ImmutableDictionary<Type, int> _componentsIndex = new Dictionary<Type, int>()
        {
            ...
            { typeof(HighlightOnChildrenComponent), 41 },
            { typeof(HighlightSpriteComponent), 42 },
            { typeof(IdTargetCollectionComponent), 43 },
            { typeof(IdTargetComponent), 44 },
            { typeof(IgnoreTriggersUntilComponent), 45 },
            { typeof(IndestructibleComponent), 46 },
            { typeof(InstanceToEntityLookupComponent), 47 },
            { typeof(InteractOnCollisionComponent), 48 },
            { typeof(InteractOnRuleMatchCollectionComponent), 49 },
            { typeof(InteractOnRuleMatchComponent), 50 },
            { typeof(InteractOnStartComponent), 51 },
            { typeof(InteractorComponent), 52 },
            ...
            { typeof(NineSliceComponent), 58 },
            { typeof(ParallaxComponent), 59 },
            { typeof(ParticleSystemComponent), 60 },
            { typeof(ParticleSystemWorldTrackerComponent), 61 },
            { typeof(PathfindComponent), 62 },
            { typeof(PauseAnimationComponent), 63 },
            { typeof(PickEntityToAddOnStartComponent), 64 },
            { typeof(PolygonSpriteComponent), 65 },
            { typeof(PrefabRefComponent), 66 },
            { typeof(PushAwayComponent), 67 },
            { typeof(QuadtreeComponent), 68 },
            { typeof(QuestTrackerComponent), 69 },
            { typeof(QuestTrackerRuntimeComponent), 70 },
            { typeof(RandomizeSpriteComponent), 71 },
            { typeof(RectPositionComponent), 72 },
            { typeof(RemoveColliderWhenStoppedComponent), 73 },
            { typeof(RemoveEntityOnRuleMatchAtLoadComponent), 74 },
            { typeof(RequiresVisionComponent), 75 },
            { typeof(RoomComponent), 76 },
            { typeof(RotateComponent), 77 },
            { typeof(RouteComponent), 78 },
            { typeof(RuleWatcherComponent), 79 },
            { typeof(SituationComponent), 80 },
            { typeof(SoundComponent), 81 },
            { typeof(SoundParameterComponent), 82 },
            { typeof(SpeakerComponent), 83 },
            { typeof(SpriteComponent), 84 },
            { typeof(StrafingComponent), 85 },
            { typeof(TextBoxComponent), 86 },
            { typeof(TextureComponent), 87 },
            { typeof(ThreeSliceComponent), 88 },
            { typeof(TileGridComponent), 89 },
            { typeof(TilesetComponent), 90 },
            { typeof(UiDisplayComponent), 91 },
            { typeof(VelocityComponent), 92 },
            { typeof(VerticalPositionComponent), 93 },
            { typeof(WaitForVacancyComponent), 94 },
            { typeof(WindowRefreshTrackerComponent), 95 },
            { typeof(IStateMachineComponent), 96 },
            { typeof(IInteractiveComponent), 97 },
            { typeof(IMurderTransformComponent), 98 },
            { typeof(ITransformComponent), 98 },
            { typeof(StateMachineComponent<Coroutine>), 96 },
            { typeof(StateMachineComponent<DialogStateMachine>), 96 },
            { typeof(InteractiveComponent<AddChildOnInteraction>), 97 },
            { typeof(InteractiveComponent<AddComponentOnInteraction>), 97 },
            { typeof(InteractiveComponent<AddEntityOnInteraction>), 97 },
            { typeof(InteractiveComponent<AdvancedBlackboardInteraction>), 97 },
            { typeof(InteractiveComponent<BlackboardActionInteraction>), 97 },
            { typeof(InteractiveComponent<DebugInteraction>), 97 },
            { typeof(InteractiveComponent<InteractionCollection>), 97 },
            { typeof(InteractiveComponent<RemoveEntityOnInteraction>), 97 },
            { typeof(InteractiveComponent<SendToOtherInteraction>), 97 },
            { typeof(InteractiveComponent<SetPositionInteraction>), 97 },
            { typeof(InteractiveComponent<TalkToInteraction>), 97 },
            { typeof(PositionComponent), 98 },
            { typeof(PositionRotationComponent), 98 }
        ...
        {
            { typeof(AnimationCompleteMessage), 99 },
            { typeof(CollidedWithMessage), 100 },
            { typeof(FatalDamageMessage), 101 },
            { typeof(HighlightMessage), 102 },
            { typeof(InteractMessage), 103 },
            { typeof(InteractorMessage), 104 },
            { typeof(IsInsideOfMessage), 105 },
            { typeof(NextDialogMessage), 106 },
            { typeof(OnActorEnteredOrExitedMessage), 107 },
            { typeof(OnInteractExitMessage), 108 },
            { typeof(OnTriggerEnteredMessage), 109 },
            { typeof(PathNotPossibleMessage), 110 },
            { typeof(PickChoiceMessage), 111 },
            { typeof(TouchedGroundMessage), 112 }
        }.ToImmutableDictionary();
